    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 51, 0, 1187);
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file, 54, 2, 1241);
    			add_location(label0, file, 53, 0, 1231);
    			add_location(h1, file, 58, 0, 1317);
    			attr_dev(input2, "type", "checkbox");
    			attr_dev(input2, "name", "color");
    			input2.__value = "red";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[19][0].push(input2);
    			add_location(input2, file, 60, 2, 1352);
    			add_location(label1, file, 59, 0, 1342);
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "name", "color");
    			input3.__value = "green";
    			input3.value = input3.__value;
    			/*$$binding_groups*/ ctx[19][0].push(input3);
    			add_location(input3, file, 64, 2, 1450);
    			add_location(label2, file, 63, 0, 1440);
    			attr_dev(input4, "type", "checkbox");
    			attr_dev(input4, "name", "color");
    			input4.__value = "blue";
    			input4.value = input4.__value;
    			/*$$binding_groups*/ ctx[19][0].push(input4);
    			add_location(input4, file, 68, 2, 1552);
    			add_location(label3, file, 67, 0, 1542);
    			option0.__value = "green";
    			option0.value = option0.__value;
    			add_location(option0, file, 73, 2, 1682);
    			option1.__value = "red";
    			option1.value = option1.__value;
    			add_location(option1, file, 74, 2, 1721);
    			option2.__value = "blue";
    			option2.value = option2.__value;
    			add_location(option2, file, 75, 2, 1756);
    			if (/*singleFavColor*/ ctx[5] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[22].call(select));
    			add_location(select, file, 72, 0, 1643);
    			add_location(hr0, file, 78, 0, 1802);
    			attr_dev(input5, "type", "text");
    			add_location(input5, file, 80, 0, 1810);
    			add_location(button0, file, 81, 0, 1858);
    			add_location(div, file, 83, 0, 1901);
    			add_location(hr1, file, 85, 0, 1930);
    			...
    			add_location(input6, file, 88, 2, 1972);
    			attr_dev(button1, "type", "submit");
    			button1.disabled = button1_disabled_value = !/*formIsValid*/ ctx[10];
    			add_location(button1, file, 89, 2, 2075);
    			add_location(form, file, 87, 0, 1938);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
