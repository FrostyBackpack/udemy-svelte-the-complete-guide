...
var app = (function () {
    ...
    /* src\UI\Header.svelte generated by Svelte v3.51.0 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1txcjdf");
    			add_location(h1, file$5, 4, 2, 35);
    			attr_dev(header, "class", "svelte-1txcjdf");
    ...
    /* src\UI\Button.svelte generated by Svelte v3.51.0 */
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 10, 2, 152);
    		},
    		m: function mount(target, anchor) {
    ...
    /* src\Meetups\MeetUpItem.svelte generated by Svelte v3.51.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	button2 = new Button({
    			props: { type: "button", caption: "Favourite" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 12, 4, 228);
    			attr_dev(h2, "class", "svelte-enhpap");
    			add_location(h2, file$3, 13, 4, 250);
    			attr_dev(p0, "class", "svelte-enhpap");
    			add_location(p0, file$3, 14, 4, 275);
    			attr_dev(header, "class", "svelte-enhpap");
    			add_location(header, file$3, 11, 2, 214);
    			...
    			add_location(img, file$3, 17, 4, 333);
    			attr_dev(div0, "class", "image svelte-enhpap");
    			add_location(div0, file$3, 16, 2, 308);
    			attr_dev(p1, "class", "svelte-enhpap");
    			add_location(p1, file$3, 20, 4, 408);
    			attr_dev(div1, "class", "content svelte-enhpap");
    			add_location(div1, file$3, 19, 2, 381);
    			attr_dev(footer, "class", "svelte-enhpap");
    			add_location(footer, file$3, 22, 2, 442);
    ...
    /* src\Meetups\MeetUpGrid.svelte generated by Svelte v3.51.0 */
    ...
    /* src\UI\TextInput.svelte generated by Svelte v3.51.0 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 14, 4, 305);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 12, 4, 247);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$1, 10, 2, 174);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 60, 2, 2158);
    			attr_dev(main, "class", "svelte-14fgpj0");
    			add_location(main, file, 57, 0, 1891);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
