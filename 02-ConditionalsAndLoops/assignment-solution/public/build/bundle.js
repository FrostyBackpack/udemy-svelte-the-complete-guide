...
var app = (function () {
    ...
    // (45:0) {#if passwordValidity === "short"}
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(45:0) {#if passwordValidity === \\\"short\\\"}",
    		ctx
    	});
    ...
    // (54:2) {#each passwords as pw, i (pw)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 54, 4, 1466);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(54:2) {#each passwords as pw, i (pw)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 27, 0, 561);
    			add_location(p, file, 29, 0, 582);
    			add_location(li0, file, 32, 2, 616);
    			add_location(li1, file, 33, 2, 693);
    			add_location(li2, file, 34, 2, 807);
    			add_location(li3, file, 35, 2, 891);
    			add_location(li4, file, 36, 2, 963);
    			add_location(li5, file, 37, 2, 1042);
    			add_location(ol, file, 31, 0, 609);
    			attr_dev(input, "type", "password");
    			add_location(input, file, 40, 0, 1116);
    			add_location(button, file, 42, 0, 1172);
    			add_location(ul, file, 52, 0, 1423);
    		},
